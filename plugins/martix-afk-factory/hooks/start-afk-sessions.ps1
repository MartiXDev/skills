...
foreach ($issue in $issues) {
  ...
  # Write start prompt into worktree
...
---
*Generated by start-afk-sessions.ps1. Open this file in the Copilot CLI
session started for this worktree, or enable the Agents Window and open this
folder as a new session. Use /remote on for remote monitoring.*
"@ | Set-Content $startFile -Encoding UTF8
  ...
  Write-Host "    VS Code opened. Start a Copilot CLI session in the Agents Window."
