...
>
> **Hard constraint:** **Do not use, summarize, copy, or rely on any information** from `docs/knowledge/ai/llm/llm-cost-strategy-by-sonnet-5.md` (or any previous research file). Re-research all findings from primary/current sources.
