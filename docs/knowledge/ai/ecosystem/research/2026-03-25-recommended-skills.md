...
The stable folder layout, `npx skills` commands, local-import example, and
verification steps now live in the
[Skills installation guide](../../../../guides/skills-installation.md). Keep
this dated document focused on volatile recommendations and source discovery.
