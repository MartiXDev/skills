...
([Custom AI artifact rules](../../../../../docs/policy/custom-ai-artifact-rules.md#evals)).
Šablona navíc obsahuje `assertions`, `token_budget`, `negative_activation` a
`escalation` ([repo šablona evalů](../../../../../templates/skill-package/evals/evals.json)).

Současný [repo validátor](../../../../../scripts/validate-repository.ps1)
kontroluje top-level `skill`, přítomnost případů, `id`, `prompt`, očekávaný
výstup, model tier,
