...
Use [Execution and routing](../guides/execution-and-routing.md) for model tiers,
task classification, token budgets, and parallel-safety vocabulary. Use
[Parallel worktree guidance](../guides/parallel-worktree-guidance.md) for the
procedure and shared-file ownership rules.
